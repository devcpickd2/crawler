    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="demo-inline-spacing">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <form class="form-inline" action="<?= base_url('suhu_ruangan/print_pdf');?>" method="post" target="_blank">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- <a href="<?= base_url('suhu_ruangan/print_pdf/' . $val->uuid); ?>" class="btn btn-info" target="_blank">
