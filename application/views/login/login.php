...
<head>
    ...
    <title>Login CPI-NET TALK</title>
                ...
                <div class="authentication-inner">
                    <div class="card">
                        <div class="card-body">
                            <div class="app-brand justify-content-center">
                                <a href="<?= base_url('login'); ?>" class="app-brand-link gap-2">
                                    <span class="app-brand-logo demo">
                                        <img src="<?= base_url('assets/img/cpi-logo.png') ?>" alt="CPI Logo"
                                            style="max-width: 50px;">
                                    </span>
                                    <span class="app-brand-text demo text-body fw-bolder">CPI-NET TALK</span>
                                </a>
                            </div>
                            ...
                            <?php } ?>
                            <h4 class="mb-2 text-center">Welcome to CPI-NET TALK! 👋</h4>
