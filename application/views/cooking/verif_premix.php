...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Form Cooking /</span> Peneraan Verifikasi Premix</h4>
        ...
        <!-- Responsive Table -->
        <div class="card">
            <h5 class="card-header">Data Peneraan Verifikasi Premix</h5>
