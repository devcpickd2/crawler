...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= base_url('timbangan/tambah') ?>" method="post">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="kode_timbangan" name="kode_timbangan" placeholder="Masukkan kode Timbangan/area..." required>
                            </div>
                            <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <a href="<?= base_url('timbangan')?>" class="btn btn-danger"><i class="bx bx-x"></i> Batal</a>
                    </div>
                </form>
            </div>
        </div>
